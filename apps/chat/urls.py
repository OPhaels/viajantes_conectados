...
urlpatterns = [
    ...
    path('iniciar/<uuid:uuid_usuario>/viagem/<uuid:uuid_plano>/',
                                                      views.view_iniciar_conversa_viagem, name='iniciar_conversa_viagem'),
    ...
    path('nao-lidas/detalhes/',                       views.view_nao_lidas_detalhes_json, name='nao_lidas_detalhes'),
    ...
    path('desfazer-amizade/<uuid:uuid_amigo>/',       views.view_desfazer_amizade_ajax,   name='desfazer_amizade_ajax'),
]