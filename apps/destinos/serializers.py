...
from .models import EnderecoPlano, OfertaResidencia, Pais, PlanoViagem
...
class PlanoViagemSerializer(serializers.ModelSerializer):
    ...
    pais_destino_id = serializers.PrimaryKeyRelatedField(
        queryset=Pais.objects.all(), write_only=True, source="pais_destino"
    )
    ...
    motivo_viagem_display = serializers.CharField(
        source="get_motivo_viagem_display", read_only=True
    )
    nivel_privacidade_display = serializers.CharField(
        source="get_nivel_privacidade_display", read_only=True
    )
    ...
    class Meta:
        ...
        fields = [
            ...
            "flexibilidade_datas",
            "motivo_viagem",
            "motivo_viagem_display",
            "descricao",
            "nivel_privacidade",
            "nivel_privacidade_display",
        ...
        read_only_fields = ["uuid", "usuario", "data_criacao", "data_atualizacao"]
