...
class FormularioCadastroUsuario(UserCreationForm):
    ...
    password1 = forms.CharField(
        widget=forms.PasswordInput(attrs={'class': 'form-control', 'placeholder': 'Senha forte'}),
        label=_('Senha')
    )
...
class FormularioEditarPerfil(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'nome_completo':     forms.TextInput(attrs={'class': 'form-control form-control-custom'}),
            'data_nascimento':   forms.DateInput(attrs={'class': 'form-control form-control-custom', 'type': 'date'}, format='%Y-%m-%d'),
            'telefone':          forms.TextInput(attrs={'class': 'form-control form-control-custom'}),
            'pais_residencia':   forms.TextInput(attrs={'class': 'form-control form-control-custom'}),
            'cidade_residencia': forms.TextInput(attrs={'class': 'form-control form-control-custom'}),
            'biografia':         forms.Textarea(attrs={'class': 'form-control form-control-custom', 'rows': 4}),
            'foto_perfil':       forms.FileInput(attrs={'class': 'form-control form-control-custom'}),
            ...
            'mostrar_telefone':  forms.CheckboxInput(attrs={'class': 'form-check-input'}),
        }
